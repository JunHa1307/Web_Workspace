...
public class JqAjaxController2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 요청처리를 다 했다는 가정 하에 응답할 데이터를 "문자열" 형태로 세팅
...
//		
		// 버전2) 응답데이터 여러개 보내고 싶을 때 "JSON"형태로 
		/*
		 * JSON(JavaScriptObjectNotation : 자바스크립트의 객체 표기법);
		 ...
		 *  2. JSONObject{key:value,Key:value,key:value} : 객체형태
		 *  
		 */
		// 배열형태
...
//		response.getWriter().print(jArr);
		...
		jobj.put("age", age); //  {name : "홍길동","age":123}
