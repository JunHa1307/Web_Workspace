...
public class MyFileRenamePolicy implements FileRenamePolicy{
	...
	/*
	 * 반드시 미완성된 rename메소드를 오바라이딩해서 구현해야함
	...
	public File rename(File originFile) {
		...
		// 수정 파일명 : 파일 업로드시간(년월일시분초) + 5자리 랜덤값(10000~99999) => 최대한 이름이 겹치지 않게
		...
		/*
		 * 파일명 중간에 .이 들어가는 경우가 있기 때문에 원본파일명에서 가장 마지막 .의 인덱스를 기준으로 파일명과 확장자를 나눌예정
		 */
