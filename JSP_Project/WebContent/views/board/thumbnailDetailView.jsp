	...
	<div class="outer">
		...
		<table class="detail-area" align="center">
			...
			<tr>
				<td>상세사진</td>
				<td colspan="3">
					<img src="<%= contextPath + list.get(1).getFilePath()+list.get(1).getChangeName()%>" width="200" height="150">
					<img src="<%= contextPath + list.get(2).getFilePath()+list.get(2).getChangeName()%>" width="200" height="150">
					<img src="<%= contextPath + list.get(3).getFilePath()+list.get(3).getChangeName()%>" width="200" height="150">
				</td>
			</tr>
		</table>
	</div>
